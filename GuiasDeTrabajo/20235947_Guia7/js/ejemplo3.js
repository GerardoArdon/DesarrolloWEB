...
const startDOM = () => {
    ...
    buttonFondo.addEventListener("change", () => cambiarColorFondo(buttonFondo.value), false);
    buttonFondo.select();
    ...
    buttonTitulos.addEventListener("change", () => cambiarColorTitulos(buttonTitulos.value), false);
    ...
    buttonParrafos.addEventListener("change", () => cambiarColorParrafos(buttonParrafos.value), false);
    buttonParrafos.select();

    // Obteniendo las referencias de los botones para cambiar el tamaño del texto
